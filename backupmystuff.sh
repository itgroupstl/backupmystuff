...
username_hash="QUtJQVlJWk1PxxxxxxGQzNJSUVKUEI="
password_hash="QkRjSjA1Y2MrbUI3SGxxxxxxxxxxU90elNmb1BZU2JXcHptQ21YL2k="
from_name="AWS - Local"
...
# Display the prompt
read -p "Is the backup file size ok? Proceed? (y/n/c) " ANSWER <<< "$1"
